...
// 组件Leader集群：redis-cli --cluster create 10.233.97.157:6379 10.233.75.69:6379 10.233.74.65:6379 --cluster-yes -a <password>
...
func ExecuteRedisClusterCommand(cr *redisv1beta1.RedisCluster) {
	...
	default:
		// 组建Leader集群：redis-cli --cluster create 10.233.97.157:6379 10.233.75.69:6379 10.233.74.65:6379 --cluster-yes -a <password>
